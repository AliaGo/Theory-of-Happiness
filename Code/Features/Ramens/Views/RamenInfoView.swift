            ...
            VStack(alignment: .leading) {
                ...
                */
                ...
                ScrollView(.vertical, showsIndicators: false){
                    HStack {
                        ForEach(0...4, id:\.self){ url in
                            AsyncImage(url: URL(string: ramen.imageURL[url])) { image in
                                image.resizable()
                            } placeholder: {
                                Color.black
                            }
